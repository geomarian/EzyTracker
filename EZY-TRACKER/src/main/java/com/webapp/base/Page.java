...
public abstract class Page {
	...
	public <TPage extends BaseClass> TPage getInstance(Class<TPage> pageClass) {
		...
		try {
			/*
			 * At the runtime, Whatever the page class is passing (ex:
			 * homepage/loginpage, it check below constructor and get the
			 * Webdriver instance and creating object of that particular class
			 * instead of writing page (ex: login page page = new login page) so
			 * instead of new keyword, it uses new instance
			 * 
